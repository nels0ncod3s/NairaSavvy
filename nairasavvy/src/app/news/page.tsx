...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    description: "CBN circulars. Fintech updates. Translated into plain English.",
    url: "/news",
  },
};
      ...
      <main style={{ backgroundColor: "#F5F0E8" }}>
        ...
        >
          <div className="container-content" style={{ maxWidth: "800px" }}>
            <span className="category-tag" style={{ marginBottom: "20px", display: "inline-block" }}>News</span>
            ...
            <p className="type-body" style={{ color: "#6B6560", maxWidth: "600px", marginBottom: "0", fontSize: "18px", lineHeight: "1.7" }}>
              Every CBN directive, fintech policy change, and banking update that affects your money \u2014 explained without the regulatory jargon.
            </p>
          </div>
        </section>
        <section style={{ padding: "0 24px 100px" }}>
          <div className="container-content">
            <h2 className="type-h2" style={{ color: "#1A1A1A", marginBottom: "40px" }}>Latest</h2>
