...
export function SourcesBlock({ sources }: SourcesBlockProps) {
  ...
  return (
    ...
    >
        ...
        {sources.map((source, index) => (
          ...
          >
            ...
            <span>
              ...
              <span style={{ color: "#6B6560" }}>({source.year})</span>
              {source.description && (
      ...
      >
        NairaSavvy verifies information before publishing. Sources are linked
        for transparency. If you spot an error or an outdated figure, email us
        at hello@nairasavvy.ng and we will correct it.
      </p>
    </div>
  );
}
